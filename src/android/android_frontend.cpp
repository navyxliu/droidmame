...
//	}
//	
//	//emu = neomame, playgame = kof97
//	__android_log_print(ANDROID_LOG_DEBUG, "libMAME4all.so", "emu = %s, playgame = %s", playemu, playgame);
	/* Execute Game */
	//execute_game (playemu,playgame);
#if 0
	strcpy(playemu, "neomame");
	strcpy(playgame, "kof97");
#else
        strcpy(playemu, "mame");
        strcpy(playgame, "sf2");
        //show_options("sf2");
